...
|---|---|---|---|
| [`01_basic_symbols.md`](01_basic_symbols.md) | [`notebooks/01_basic_symbols.ipynb`](notebooks/01_basic_symbols.ipynb) | 等号・不等号・無限・±・比例 ∝・条件の縦棒 \| | 30 分 |
...
- 📕 **[プログラマの数学 第2版](../appendix/books.md#プログラマの数学-第2版)** (結城浩) — 記号と論理を物語形式で
