...
> 📖 **腰を据えて学ぶなら** [`00_notation/07_decorations_and_fonts.md`](../00_notation/07_decorations_and_fonts.md)。
> サイコロを使った具体例、Python 実装、対話ノートブックで体感できます。ここは逆引き用の一覧です。
...
> 📖 **腰を据えて学ぶなら** [`00_notation/07_decorations_and_fonts.md`](../00_notation/07_decorations_and_fonts.md)（黒板太字の由来、太字と shape の対応も扱っています）。
